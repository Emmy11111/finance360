    ...
    return(
        <View style={styles.container}>
         ...
         <View style={{justifyContent: 'center',alignItems: "center",marginTop: -15}}>
            <Text style={{fontSize: 24,color: "#FFF",fontWeight: "bold"}}>My Debt</Text>
        </View>
            </View>
        ...
        <FontAwesome 
            ...
            <TouchableOpacity
                    style={styles.signIn}
                    onPress={()=>navigation.navigate("myNewDebt")}
                >
                <LinearGradient
                    colors={['#FF7518', '#FF7518']}
                    style={styles.signIn}
                ...
                <View style={{backgroundColor: "#fff",padding: 15, borderRadius: 4,marginTop: 15,position: "relative"}}>
                 <Text style={{fontWeight: "bold",fontSize: 17,color: "#333333"}}>Mary Samson</Text>
