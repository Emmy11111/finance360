...
export default AddAccess = ({navigation})=>{
    ...
    return(
        <View style={styles.container}>
         ...
         <View style={{justifyContent: 'center',alignItems: "center",marginTop: -15}}>
            <Text style={{fontSize: 24,color: "#FFF",fontWeight: "bold"}}>Add Access</Text>
        </View>
            </View>

            <ScrollView style={{flex: 1}}>
            <View style={{justifyContent: 'center',alignItems: "center",marginTop: 0,padding: 20,marginBottom: 30}}>
        ...
        <View style={styles.input3}>
            ...
            <TouchableOpacity
                ...
                <View style={{justifyContent: "center",alignItems: "center",marginTop: 20,marginBottom: 20}}>
                    <Text style={{fontSize: 16,alignSelf: "center"}}>If Investor is New to Finance 360, Share link</Text>
                    <Text style={{fontSize: 16,alignSelf: "center"}}>for them to view</Text>

                    <TouchableOpacity
                    style={styles.signIn23}
                    // onPress={()=>navigation.navigate("updateDebt")}
                >
                <LinearGradient
                ...
                >
                    <Text style={[styles.textSign, {
                        color:'#fff'
                    }]}>Share Access Link</Text>
                </LinearGradient>
                </TouchableOpacity>

                <Text style={{fontSize: 16, alignSelf: "center",fontStyle: "italic",marginTop: 20}}>Link expires in 3 hours  </Text>
                </View>
