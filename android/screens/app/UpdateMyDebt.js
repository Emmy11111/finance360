...
export default UpdateMyDebt = ({navigation})=>{
 ...
 const radioButtonsData = [
    ...
    const onPressRadioButton = radioButtonsArray => {
        if(radioButtonsArray[0].selected == true){
            navigation.navigate("myNewDebt")
        }
        setRadioButtons(radioButtonsArray);
      };

    const options = [{ value: null, label: 'Creditor Name' },{ value: "1", label: 'Business Owner'},{ value: "2", label: 'Business Manager'},{ value: "3", label: 'Accountant'}]
