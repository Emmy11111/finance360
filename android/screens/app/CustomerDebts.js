...
export default CustomerDebts = ({navigation})=>{
    return(
        <View style={styles.container}>
         ...
         <View style={{justifyContent: 'center',alignItems: "center",marginTop: -15}}>
            <Text style={{fontSize: 24,color: "#FFF",fontWeight: "bold"}}>Customer Debts</Text>
        </View>
            </View>
        ...
        <FontAwesome 
            ...
            <TouchableOpacity
                ...
                <View style={{backgroundColor: "#fff",padding: 15, borderRadius: 4,marginTop: 15,position: "relative"}}>
                 <Text style={{fontWeight: "bold",fontSize: 17,color: "#333333"}}>John Mugisha</Text>
                 <Text style={{fontSize: 17,color: "#858585"}}>Tue 12.05.2021</Text>
                 <Text style={{fontWeight: "bold",fontSize: 17,color: "#333333",alignSelf: 'flex-end',position: "absolute",top: 25,right: 20}}>RF29,900</Text>
                    </View>
